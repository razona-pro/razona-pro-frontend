...
export const rankingsApi = {
  ...
  create: (p: { rankingName: string; description?: string; periodType: string; sourceFilter: string; competenceIds?: string[] }) =>
    apiFetch<RankingDto>('/api/rankings', { method: 'POST', body: JSON.stringify(p) }),
  update: (id: string, p: { rankingName?: string; description?: string; periodType?: string; sourceFilter?: string; competenceIds?: string[] }) =>
